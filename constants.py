...
INVENTORY_SLOT_HEIGHT = (SCREEN_HEIGHT / 6) - (INVENTORY_SLOT_BORDER * 2)
INVENTORY_SLOT_WIDTH = (INVENTORY_SLOT_HEIGHT * (4 / 5.0)) - (INVENTORY_SLOT_BORDER * 2)

# Container contents panel (bottom-right quadrant of the inventory screen)
CONTAINER_PANEL_X = SCREEN_WIDTH // 2
CONTAINER_PANEL_Y = 0
CONTAINER_PANEL_WIDTH = SCREEN_WIDTH // 2
CONTAINER_PANEL_HEIGHT = SCREEN_HEIGHT // 2
CONTAINER_PANEL_BORDER = 6
